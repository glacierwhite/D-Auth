...
class LocalControlUNetModel(UNetModel):
    def forward(self, x, timesteps=None, context=None, local_control=None, y=None, **kwargs):
        hs = []
...
#         emb = th.cat([emb, self.film_emb(context.squeeze(0))], dim=-1)
#         context = None
