...
parser.add_argument('---batch-size', type=int, default=32) # v100 -> 32   a100 -> 128
parser.add_argument('---training-steps', type=int, default=1e5)
# parser.add_argument('---resume-path', type=str, default='./ckpt/init.ckpt')
# parser.add_argument('---resume-path', type=str, default='./training_log/lightning_logs/version_131753/checkpoints/epoch=70-step=8000.ckpt')
parser.add_argument('---resume-path', type=str, default='./training_log/lightning_logs/version_131765/checkpoints/epoch=146-step=16500.ckpt')
...
parser.add_argument('---style-extractor', choices={'random','pretrained'}, default='random')
